...
- [spec/007-concurrency-draft.md](./spec/007-concurrency-draft.md) for the recommended structured-concurrency direction built around `group`, `spawn`, `join`, and typed channels.
