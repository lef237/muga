...
- `samples/` contains only runnable sample entrypoints, support source files for runnable entrypoints, or intentionally invalid sample trees, while post-v1 design snippets live under `docs/design-snippets/`
