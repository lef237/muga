...
The next implementation slice is continuing the package-aware checking migration: use the module signature environments as the basis for body typechecking, then move loaded-interface signatures into semantic analysis instead of expanding the legacy flattened AST rewrite path.
