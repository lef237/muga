...
The next implementation slice is continuing the package-aware checking migration: broaden package-aware module body typechecking and then move loaded-interface signatures into semantic analysis instead of expanding the legacy flattened AST rewrite path.
